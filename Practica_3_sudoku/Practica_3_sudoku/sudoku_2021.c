...
//PASARELAS
uint8_t pasarela_valor_es_pista(uint8_t fila, uint8_t columna, uint8_t valor){
	return valor_es_pista(cuadricula_C_C[fila+1][columna+1], valor);
}
uint8_t pasarela_celda_es_pista(uint8_t fila, uint8_t columna){
	return celda_es_pista(cuadricula_C_C[fila][columna]);
}
...
int pasarela_obtener_candidatos(uint8_t fila, uint8_t columna){
	return obtener_candidatos(cuadricula_C_C[fila][columna]);
}
void pasarela_celda_eliminar_candidato(uint8_t fila, uint8_t columna, uint8_t valor){
	celda_eliminar_candidato(cuadricula_C_C[fila][columna], valor);
}
