...
void
pintar_tiempo_partida(int tiempo);

void
pintar_tiempo_calculos(unsigned int tiempo);

void
actualizar_tiempo_partida(int tiempo_partida);

void
actualizar_tiempo_calculos(unsigned int tiempo);
...
void
pintar_candidatos(int izq, int arriba, int k);
